...
│   │   ├── generateDestinationFlow.ts  # Destination AI flow (editable)
│   │   ├── generateDiaryFlow.ts       # Diary AI flow (editable)
│   │   ├── dailyDiaryFlow.ts # Firestore and email helpers for diaries (editable)
